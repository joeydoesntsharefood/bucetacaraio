...
const Questions: IQuestion[] = [
  // Okay
  {
    ...
    giftText:
      "Acredita que o Fuher gosta tanto de ti que ele sumiu durante uma semana inteira, quando voltou fez a maior propaganda sua ?"
  },
  // Okay
  {
  ...
  // Okay
  {
    ...
    options: [
      ...
      "Teteu",
      "Lucas",
      "Lokix, Não sou gaucho, mas obrigado pelo elogio"
    ],
    gift:
      "https://raw.githubusercontent.com/joeydoesntsharefood/GiftFamilyNigth/a91be774027aa3990b496bd1b529cacb2bad2965/gift-family/src/RenderQuestions/imgs/gift6.jpg?raw=true",
  ...
  // Okay
  {
    ...
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/main/gift-family/src/RenderQuestions/imgs/gift8.jpg?raw=true",
  ...
  //
  {
    ...
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/31ce4495a9f6c72456f9537a7cdd99fd8136af5e/gift-family/src/RenderQuestions/imgs/gift12.jpg?raw=true",
  ...
  // Okay
  {
    ...
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/cad112a38d02d1b445585fa95be58ccd7dd04543/gift-family/src/RenderQuestions/imgs/gift5.mp4?raw=true",
    giftText:
      "Sério Lorrany, você consegue superar qualquer coisa que fazemos, parabéns !",
    video: true,
    videoMute: true
  },
  // Okay
  {
    ...
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/1dbc72df0e6d24d5cefae387876623430e0dcd06/gift-family/src/RenderQuestions/imgs/gift7.jpg?raw=true",
  ...
  // Okay
  {
    ...
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/f10cb89a99bc7efa215302fd185ac4dd86b051c1/gift-family/src/RenderQuestions/imgs/gift11.jpg?raw=true",
    giftText: "@frog.wil"
  },
  // Okay
  {
    ...
    gift:
      "https://cdn.vox-cdn.com/thumbor/tYW7_2OBEsfJ3BKsdq_fCLYG5Vk=/0x0:722x800/1200x0/filters:focal(0x0:722x800):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/10838093/LUL.jpg",
  ...
  // Okay
  {
    ...
    gift:
      "https://i.pinimg.com/736x/d2/0f/b9/d20fb9dcc0cc24df7266ba9c602006ff.jpg",
  ...
  // Okay
  {
    ...
    gift:
      "https://img.ifunny.co/images/d44c1c0df5330cab7158b40a95271f1b90c4bb57cfed42fb3d81d3cf9c8e945e_1.jpg",
  ...
  // Okay
  {
    ...
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/cad112a38d02d1b445585fa95be58ccd7dd04543/gift-family/src/RenderQuestions/imgs/gift4.jpg?raw=true",
  ...
  // Okay
  {
    ...
    options: [
      ...
      "Fuher",
      "Mat(h)eus",
      "Hector, Quem é Hector, Lorrany ?"
    ],
    gift:
      "https://github.com/joeydoesntsharefood/GiftFamilyNigth/blob/f10cb89a99bc7efa215302fd185ac4dd86b051c1/gift-family/src/RenderQuestions/imgs/gift10.png?raw=true",
