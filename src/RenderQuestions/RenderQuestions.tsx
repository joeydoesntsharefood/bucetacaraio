  ...
  return (
    <>
      ...
      {!(final === answersCorrect) && (
        <div>
          {erro && (
            <Alert message={textErro} type="error" className="erro-alert" />
          )}
          {!giftVisible && (
            <p className="p-count">
          ...
          {!giftVisible && (
            <Form form={form} onFinish={(e) => testing(e)}>
              <Form.Item
                ...
                <Radio.Group buttonStyle="solid" optionType="button">
                  {options &&
                    options.map((item: string) => (
                      <Radio value={item} className="options">
                        {item}
                      </Radio>
                    ))}
                </Radio.Group>
          ...
          {giftVisible && (
            <div>
              ...
              {!video && (
                <Image src={giftImg} className="img-gift" preview={false} />
              )}
